...
<div class="container pt-5 pb-5 text-justify" id="themes" >
	...
	<div class="pt-5 pb-5"  style="display:flex; flex-direction: row;   justify-content: space-around;">
									<div class="col-xs-4 "><img src="img/turbine.jpg" alt="" class="img_top" ></div>
									<div class="col-xs-4 "><img src="img/fours.jpg" alt="" class="img_top"></div>
									<div class="col-xs-4 "><img src="img/chaudiere.jpg" alt="" class="img_top"></div>
									</div>
...
Conventionnellement, toute recherche dans le domaine de la combustion a été motivée par un meilleur rendement énergétique et un minimum d'émission polluante pour préserver l'environnement. Notre activité en combustion conventionnelle se base sur ces principes. Néanmoins et dans l'avenir on s'intéressera aussi aux piles à combustible qui représentent un intérêt mondial dans le domaine de l'énergie pour un développement durable.<br>

Dans le domaine des plasmas, l'intérêt mondial est orienté vers la maîtrise des phénomènes hors équilibre thermodynamique et chimique pour le développement d'une multitude d'applications industrielles telle que les appareils de coupure électrique, les réacteurs à plasmas, et les lampes à décharge très économiques en énergie et très fidèles en rendement de luminosité.<br>
	</p>
<h3>Objectifs du programme de recherche: </h3>
			 
Les objectifs du programme de recherche en Combustion et Plasma sont :
	<ul>
	<li>La mise en place d’outils théoriques, numérique,  et expérimentaux  d’étude des transferts dans les écoulements réactifs en combustion et plasmas.</li>
	<li>L’utilisation des outils mis en place et les connaissances acquises pour maîtriser et optimiser plusieurs systèmes et procédés industriels (brûleurs, turbines à combustion,  piles à combustibles à base d'hydrocarbures, lampes à décharges, appareils de coupure électrique, réacteurs plasma).</li>
...
Nous envisageons maintenant étudier numériquement la convection naturelle et les phénomènes radiatifs dans la lampe, ainsi que les instabilités électriques et thermiques qui peuvent être néfastes dans certains cas.<br>

Concernant les réacteurs à plasma, on s'intéresse aux décharges radiofréquence dans les mélanges NH3/SiH4 pour les dépôts de films minces de nitrures de silicium. L'objectif de notre étude est la mise en place  d'un code de calcul pour la simulation numérique des réacteurs à plasma.<br>

Tout d'abord, une étude bibliographique sur les processus de dépôts chimiques en phase vapeur de films minces par la méthode "PECVD" (Plasma Enhanced Chemical Vapor Deposition) sera effectuée. Ensuite, nous nous intéresserons à la formulation mathématique.<br>
