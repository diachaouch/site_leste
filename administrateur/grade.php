    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="administrateur.php"><h4>Champions Factory</h4></a>
          <a class="navbar-brand brand-logo-mini"><h3>C F</h3></a>
        </div>
          ...
          <ul class="nav">
			...
			<li class="nav-item">
              <a class="nav-link" href="grade.php">
                <span class="menu-title">Liste des grades</span>
                <i class="mdi mdi-account-multiple menu-icon"></i>
              </a>
            </li>
