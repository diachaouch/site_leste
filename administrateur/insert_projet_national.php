...
$connect = mysqli_connect("localhost", "root", "", "leste");
 ...
 $description = mysqli_real_escape_string($connect, $_POST["description"]);
  ...
  $q="select * from projets_nationaux WHERE (type='$type' AND duree='$duree') AND (titre='$titre') AND (responsable_tunisien='$responsable_tunisien') AND (responsable_francais='$responsable_francais') ";
  ...
  $rows=mysqli_num_rows($log);
	...
	echo 'Projet déja inscrit ';	
		...
		$query = "INSERT INTO projets_nationaux (type,  duree , titre, responsable_tunisien, responsable_francais, description) VALUES(
