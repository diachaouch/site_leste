...
?>
	<table class="table table-hover ">
		<button type="button" name="add" id="add" class="btn btn-info" class="btn btn-info" data-toggle="collapse" data-target="#user_dialog">Ajouter catègorie</button>
<br/>
						<div class="container">
						<div id="display"> </div>
       ...
       if(confirm('Vous étes sure?')){
         ...
         $.ajax({
              ...
              success:function(data){
				   ...
				   $('#inserted_item_data').fadeIn('slow').load("fetch_categorie.php");
