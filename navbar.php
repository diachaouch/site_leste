...
<header id="header" class="sticky bg-white">
	 <div class="container-fluid">
      ...
      <div id="logo" class="pull-left pl-lg-5 d-flex  ">
		  ...
		  <div class="hidden-xs hidden-sm" ><h2 >LABORATOIRE D'ÉTUDES </h2><h6>DES SYSTÈMES THERMIQUES ET ÉNERGÉTIQUES</h6></div>
      ...
      <nav id="nav-menu-container">
        ...
        <ul class="nav-menu">
          ...
          <li class=" menu-has-children"><a>Présentation</a>
            <ul>
              <li><a href="presentation.php">Présentation du labo</a></li>
		...
		<li class="menu-has-children "><a href="">Thèmes de recherche</a>
            <ul>
			
              <li><a href="Thèmes-de-recherche.php">Présentation générale</a></li>
			  ...
			  <li><a href="Modelisation_et_optimisation_des_systèmes_énergétiques.php">Modélisation et optimisation des systèmes énergétiques</a> </li>
		...
		<li class="menu-has-children "><a href="">Production scientifique</a>
            ...
            <ul>
              ...
              <li><a href="projets de recherche.php">Présentation générale</a></li>
              <li><a href="cooperation.php">coopérations</a></li>
			  			  
            </ul>
          </li>
		<li class="nav-item menu-has-children "><a href="">Activitès du labo</a>
            <ul>
			
              <li><a href="activitès du labo.php">journèes & manifestations </a></li>
              <li><a href="#">galerie de photos</a></li>
